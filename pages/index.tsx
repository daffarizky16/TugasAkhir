    ...
    <div>
      ...
      <div className="flex flex-col container mx-auto justify-center py-44 m-auto space-y-3">
        ...
        <div className="text-center ">
          <span className="text-lg bg-zinc-100 py-1 px-3 font-medium">Web Voting Calon Ketua BEM Institut Teknologi Mitra Gama</span>
        </div>
        <Image src="/images/landingpage.png" alt="Picture of the header" width={300} height={300} priority objectPosition="center" objectFit="contain" />

        <div className="flex flex-row items-center justify-center space-x-5">
          <Link href="/vote/create">
            <a className="bg-sky-500 hover:bg-sky-400 text-sm font-bold text-white w-40 text-center py-3 border-2 border-transparent ">Buat Vote Baru</a>
          </Link>
          <span>atau</span>
          <Link href="/participant">
            <a className="bg-white text-sm font-bold text-zinc-800  border-sky-500 border-2 w-40 text-center py-3 hover:bg-sky-500 hover:text-white">Ikutan Vote</a>
          </Link>
        </div>
      </div>
      {/* End Header */}
      ...
      {/* End List Voting */}
      {/* footer */}
      <footer className="footer bg-sky-500 text-white text-center py-4">
        Created by <span className="font-bold">Daffa Rizky</span>
      </footer>
      {/* End footer */}
    </div>
  );
